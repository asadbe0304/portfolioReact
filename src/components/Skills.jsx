...
import sk2 from "../assets/bts.jfif";
import sk3 from "../assets/nx.png";
import sk4 from "../assets/ts.png";
import sk5 from "../assets/sk-5.png";
import sk55 from "../assets/sass.png";
import sk6 from "../assets/rdx.png";
import sk7 from "../assets/tl.jfif";
...
import sk12 from "../assets/vj.png";
        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              num="1"
              title="Ui/Ux Design"
              desc="To get an opportunity where I can make the
            ...
            <Service
              ...
              desc="Seeking a challenging position in a reputed
            ...
            <Service
              ...
              desc="As a frontend developer, I am passionate about
                            creating dynamic and interactive web
                            applications. With a strong foundation in frontend development including HTML, CSS and
                            JavaScript, I am experienced in developing
                            responsive web interfaces that meet user
                            requirements."
              data={[
                "Prototype",
                "Wireframe",
