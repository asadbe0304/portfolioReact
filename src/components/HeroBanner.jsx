...
import gmailIcon from "../assets/sk-11.png";
  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        >
          <div className="flex items-center gap-[6px]">
            <div className="w-[35px] h-[35px] rounded-full bg-[#252525] flex justify-center items-center">
              <img src={gmailIcon} alt="" className="w-[18px] animate-spin" />
            </div>
        ...
        {/* INTRO START */}
        <motion.div
          className="flex flex-col mb-4 text-center md:text-left text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] relative"
          initial={{ y: 300, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.7, delay: 0.25 }}
        >
          <div className="font-light mb-0">
            👋 Hi, I Am <span className="font-semibold">Asadbek</span>
          </div>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <div className="text-[40px] font-light">80+</div>
          ...
          {/* START */}
          <div className="flex items-center gap-3">
            <div className="text-[40px] font-light">15+</div>
            <div className="leading-[20px]">
              YEARS OF
              <br />
              EXPERIENCE
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <img src={man} alt="author images" className="rounded-full animate-pulse" />

          {/* HIRE ME BUTTON START */}
          <div
            style={{ right: -15 }}
            className="absolute top-[160px] 2xl:top-[240px] 2xl:-right-10 w-[140px] h-[140px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
            onClick={() => scrollTo("contact")}
          >
